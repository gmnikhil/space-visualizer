...
public final class DiagnosticViewModel: ObservableObject {
    ...
    public var title: String {
        isPreview ? "SpaceVisualizer feasibility preview" : "SpaceVisualizer diagnostic"
    }
    ...
    public var metadataPermissionExplanation: String {
        "SpaceVisualizer reads Music metadata only to show track identity and playback state; it does not control playback or sign in."
    }
...
public protocol SpaceVisualizerClock {
    func uptimeNanoseconds() -> UInt64
}

public struct SystemSpaceVisualizerClock: SpaceVisualizerClock {
    public init() {}
