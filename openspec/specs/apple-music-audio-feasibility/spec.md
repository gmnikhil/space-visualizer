...
- **THEN** the diagnostic transitions to a visible recoverable error state, stops consuming the invalid stream, preserves the user's Music playback, and does not keep stale signal values running
